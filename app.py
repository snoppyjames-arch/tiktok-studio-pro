...
.card.cyan-border .card-title { color: #00f2ea; }
.badge-type { border: 1px solid #00f2ea; color: #00f2ea; font-size: 10px; padding: 3px 8px; border-radius: 8px; font-weight: 600; }
...
<div class="bottom-nav">
    <a href="#" class="nav-item"><svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>Home</a>
    <a href="#" class="nav-item"><svg viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>Create</a>
    <a href="#" class="nav-item active"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>Studio Pro</a>
    <a href="#" class="nav-item"><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>Inbox</a>
    <a href="#" class="nav-item"><svg viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>Profile</a>
</div>
...
async function generate(){
  ...
  document.getElementById('result').innerHTML = `
    <div class="card">
        <div class="card-header"><h3 class="card-title">💡 VIRAL CONCEPT & IMAGE</h3><span class="badge-type">AI VISUAL</span></div>
        ...
        <div class="action-row">
            ...
            <a class="action-btn" href="${data.image1}" target="_blank">Download Image 📥</a>
        </div>
    </div>
    ...
    <div class="card cyan-border">
        <div class="card-header"><h3 class="card-title">🎬 AI CINEMATIC FRAME & SCRIPT</h3><span class="badge-type">30S ASSET</span></div>
    ...
    <div class="card">
        <div class="card-header"><h3 class="card-title">🚀 THUMBNAIL & VIDEO ASSET</h3><span class="badge-type">VIDEO CONCEPT</span></div>
